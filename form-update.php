...
$data_dosen = mysqli_connect_error($result);
   ...
   <body>
     ...
     <form action="update.php?kode=<?php echo $_GET['kode']; ?>" method="post">
       ...
       <td><input type="text" name="nama_matkul" id="nama_matkul"
                  value=" <?php $data_dosen['nama_matkul']; ?>"></td>
       </tr>
       ...
       <td><input type="number" name="semester" id="semester"
                  value=" <?php $data_dosen['semester']; ?> "></td>
       </tr>
